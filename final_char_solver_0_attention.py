...
ЭКСПЕРИМЕНТ С ДОБАВЛЕНИЕМ ATTENTION слоёв (https://github.com/philipperemy/keras-attention-mechanism)
'''
...
training_dataset = vectorizer.get_train_char_vectorization(swap_questions=False, re_weight=RE_WEIGHT)
...
left_seq0 = Reshape((CHAR_DIMS*max_sent_len,))(left_seq0)
...
right_seq0 = Reshape((CHAR_DIMS*max_sent_len,))(right_seq0)
...
#merged = Dense(units=int(dense_units/8), activation='relu')(merged)
#merged = Dropout(DROPOUT_RATE)(merged)
#merged = BatchNormalization()(merged)
